  ...
  return (
    <div className="privacyPolicy">
      ...
      <p>
        ...
        being used online. PII, as used in NZ privacy law and information
      ...
      <p>
        We use vulnerability scanning and/or scanning to PCI standards. We use
        an SSL certificate.
      </p>
      ...
      <p>
        ...
        cookies to compile aggregate data about site traffic and site
      ...
      <p>
        ...
        cookies. If you disable cookies off, some features maybe disabled and
      ...
      <p>
        ...
        to other parties for marketing, advertising, or other uses. personally
        identifiable information. We may also release your information when we
      ...
      <p>
        ...
        the users via email within 7 business days. We also agree to the
        individual redress principle, which requires that individuals have a
        right to pursue legally enforceable rights against data collectors and
      ...
      <h3>Contacting Us</h3>
      <p>
        If there are any questions regarding this privacy policy you may enquire
        via the <a href="/contact/">contact page.</a>
      </p>
      <p>Last Edited on 22.04.2022</p>
    </div>
  );
};
