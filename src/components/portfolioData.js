const portfolioData = {
  "liberate-it-website": {
    ...
    description: `<p><strong>This project was part of an overall overhaul that I completed in 2019 for Liberate I.T. and included many pieces of collateral as well as the website. </strong></p>
...
`,
  ...
  "liberate-it-edm": {
    ...
    description: `<p>As part of my work with Liberate I.T. I designed and built monthly Info Hub messaging for their existing customer base. This was set up as a means of communicating what events were coming up, free webinars customers could join in on, promotional offers, and helping them get to know the wider staff.</p>
  
    <p>These EDMs were created by hard-coding custom HTML from scratch, using a series of templates that I created for them. I then loaded their emails into NetSuite (their internal ERP system including CRM functionality), and sent it out to the customer base from there.</p>
`,
  ...
  inugo: {
    ...
    <p>While I was managing the website through 2017 and 2018, the app was active both within New Zealand and also America. Because of this, the client needed the site to be set up to serve messaging specific to different audiences and locations, without compromising performance.</p>
`,
    technicalSpec:
      "<p>Built using WordPress. Utilises WordPress, internal CRM, user geolocation-specific content. Optimised for page speed, accessibility, and mobile responsiveness.</p><p>This website was built using WordPress, and integrated with the client's internal CRM, which required custom coding to achieve.</p><p>This meant that optimisation was a priority, as the custom aspects of the build had the potential to slow down site performance. I was able to achieve this and create a happy medium.</p><p>The content within the website was configured to serve whatever message was the most appropriate for the user based on their geolocation. Both within-page content, and also full page url-based redirection was included to accommodate this.</p> ",
...
`,
  ...
  "miss-marie-web": {
    ...
    description: `<p>This project involved full roll out across a range of collateral, both online and in print. Miss Marie was a passion project of mine. It was an online store that sold pinup, gothic, steampunk and alternative clothing. </p>
...
`,
  ...
  "dns-forest-products": {
    ...
    description: `<p><strong>Working in conjunction with <a href="http://www.chriswardcreative.com/" target="_blank" rel="noreferrer">Chris Ward Creative</a>, I created a new website for DNS Forest Products. The key aims included ease of use, ease of updates, clarity of information, and being fully mobile responsive. It also needed to have a working translation option for three languages.</strong></p>

    <p>After receiving the design elements I discussed options around building, so that all of these objectives could be met. I provided the client with a full CMS that they could update themselves, as well as documentation on how to do so.</p>

    <p>I was able to create a clean, well-functioning website build that was accurate to the creative provided.</p>

    <p className="button"><a href="http://dnsltd.co.nz/" target="_blank" rel="noreferrer">View Live Site</a></p>
`,
    technicalSpec:
  ...
  "mood-hair": {
    ...
    description: `<p><strong>Mood Hair Studio is based in Drury, Auckland, and went through a rebrand in 2019. After they had done this, they approached me about creating a website to match.</strong></p>
    <p>They only wanted a simple solution, one that listed their services while also encouraging click through to their existing booking platform.</p>
...
`,
  ...
  "liberate-it-branding": {
    ...
    <p>Liberate I.T. are a top level NetSuite Solution Provider in New Zealand and Australia. I first began working with them because they wanted to overhaul their branding, which at the time was very simple and following a generic blue and grey colour scheme. Their existing logo had a star included to dot the i with, and they requested that I experiment with ways to keep a star element. After showing them a range of concepts, we all agreed on this direction.</p>
  ...
  "fluffy-duck-branding": {
    ...
    <p>Because of these two factors, I wanted to incorporate elements that reflected the client's personal style, as well as be appropriate for their audience. This meant including elegance, sophistication, and a level of wholesomeness, while also including femininity and individuality.</p> 
